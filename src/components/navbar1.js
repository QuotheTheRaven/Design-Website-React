        ...
        <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
          <nav className="navbar1-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar1-text19">Link1</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar1-text17">Link2</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar1-text18">Link3</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar1-text20">Link4</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar1-text16">Link5</span>
                </Fragment>
              )}
            </a>
          </nav>
          <div className="navbar1-buttons1">
            <button className="navbar1-action11 thq-button-filled thq-button-animated">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar1-text14">Action 1</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar1-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar1-text15">Action 2</span>
                  </Fragment>
                )}
              </span>
            </button>
